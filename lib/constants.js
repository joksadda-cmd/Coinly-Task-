...
export const AD_NETWORKS = {
  adsgram: { label: 'Adsgram', dailyLimit: 5, rewardTC: 1 },
  gigapub: { label: 'GigaPub', dailyLimit: 10, rewardTC: 1 },
  monetag: { label: 'Monetag', dailyLimit: 10, rewardTC: 1 },
};

// ─────────────────────────────────────────────────────────
// TASK COMPLETION REWARD
// ─────────────────────────────────────────────────────────
export const TASK_COMPLETE_REWARD_TC = 1;
...
// ─────────────────────────────────────────────────────────
export const SIGNUP_BONUS_TC = 20;

// ─────────────────────────────────────────────────────────
// REFERRAL
// 10 TC per successful refer.
//
// Reward is NOT paid at signup — it only activates once the referred
// person completes REFERRAL_ACTIVATION_TASKS tasks (anti-cheat: stops
// people farming fake/alt accounts for free instant TC).
// ─────────────────────────────────────────────────────────
export const REFERRAL_BONUS_TC = 10;
export const REFERRAL_ACTIVATION_TASKS = 5;
