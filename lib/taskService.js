 ...
 */
export async function postTask(db, { ownerId, type, title, link, targetChatId, totalSlots, photoUrl }) {
  ...
  const task = createTaskDoc({ ownerId, type, title, link, targetChatId: targetChatId || null, totalSlots, photoUrl: photoUrl || null });
